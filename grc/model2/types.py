...
PortDType.register('Complex Float 32',    8, '#3399FF', ('fc64', 'complex'))

PortDType.register('Float 64',            8, '#66CCCC', 'f64')
PortDType.register('Float 32',            4, '#FF8C69', ('f32', 'float'))
...
PortDType.register('Integer 32',          4, '#00FF99', ('s32', 'int'))
...
INT_TYPES = [
    int, long, np.int, np.int8, np.int16, np.int32, np.uint64,
